...
| `eval_v4/cli.py` | `eval_v4 generate \| measure \| report \| manifest-check \| real-floor`. `measure` accepts the MEASURE_ONLY names too, which is how a baseline reaches the same tables. |
