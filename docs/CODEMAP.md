...
(`sample_mask_component_audit`) · `13-downstream-utility`
(`downstream_utility`).
...
└── campaigns/                    analysis output — ONE CAMPAIGN PER QUESTION
    ...
    └── 13-downstream-utility/    results.json (every arm x seed, with the stratified
