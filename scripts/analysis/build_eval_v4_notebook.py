...
S2/PSD guards, the pore/air agreement) is withdrawn and is being re-measured with the scaling fixed. The rejection does
not depend on them: both failing gates are on the validation arm, which was decoded correctly.
""")
    code(r'''
